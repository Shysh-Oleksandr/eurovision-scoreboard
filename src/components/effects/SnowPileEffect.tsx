    ...
    <>
      ...
      {snowEffect === 'right' && (
        <Image
          ...
          alt="Snow pile"
          className={`absolute rotate-6 -right-1.5 -top-2 z-40 object-fill h-5 ${className}`}
          width={30}
          height={40}
        />
      )}
      {snowEffect === 'left' && (
        <Image
          ...
          alt="Snow pile"
          className={`absolute -left-1 -rotate-2 -top-2 z-50 object-fill h-5 pointer-events-none ${className}`}
          width={30}
          height={40}
        />
      )}
