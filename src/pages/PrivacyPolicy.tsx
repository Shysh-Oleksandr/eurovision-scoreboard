        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 shadow-2xl">
          ...
          <section className="mb-8">
            ...
            <ul className="space-y-3">
              ...
              <li className="bg-white/5 rounded-lg p-4 border border-white/10">
                <p className="text-white/90 leading-relaxed">
                  <strong className="text-white font-semibold">Company</strong>{' '}
              ...
              <li className="bg-white/5 rounded-lg p-4 border border-white/10">
                <p className="text-white/90 leading-relaxed">
                  <strong className="text-white font-semibold">Cookies</strong>{' '}
              ...
              <li className="bg-white/5 rounded-lg p-4 border border-white/10">
                <p className="text-white/90 leading-relaxed">
                  <strong className="text-white font-semibold">Country</strong>{' '}
                  refers to: Ukraine
                </p>
              </li>
              <li className="bg-white/5 rounded-lg p-4 border border-white/10">
              ...
              <li className="bg-white/5 rounded-lg p-4 border border-white/10">
                <p className="text-white/90 leading-relaxed">
                  <strong className="text-white font-semibold">Service</strong>{' '}
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2 mb-6">
              <li className="text-white/90">Email address</li>
              <li className="text-white/90">First name and last name</li>
              <li className="text-white/90">Usage Data</li>
            </ul>
          ...
          <section className="mb-8">
            ...
            <ul className="space-y-4 mb-6">
              <li className="bg-white/5 rounded-lg p-4 border border-white/10">
                ...
                <p className="text-white/80 mt-2">Type: Session Cookies</p>
                <p className="text-white/80">Administered by: Us</p>
              ...
              <li className="bg-white/5 rounded-lg p-4 border border-white/10">
                ...
                <p className="text-white/80 mt-2">Type: Persistent Cookies</p>
                <p className="text-white/80">Administered by: Us</p>
                <p className="text-white/90 mt-2">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2 mb-6">
              <li className="text-white/90">Comply with a legal obligation</li>
              ...
              <li className="text-white/90">Protect against legal liability</li>
            </ul>
          </section>
